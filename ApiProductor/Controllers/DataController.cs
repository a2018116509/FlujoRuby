namespace ApiProductor.Controllers
{
    ...
    public class DataController : ControllerBase
    {
        ...
        {
            string connectionString = "Endpoint=sb://queuemariana.servicebus.windows.net/;SharedAccessKeyName=enviar;SharedAccessKey=0BfL7noS7fsllf/eOfecu5rZNbVDVKWFoxTS+NeTalM=;EntityPath=cola1";
